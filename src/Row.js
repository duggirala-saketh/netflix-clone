...
function Row({ title, fetchUrl, isLargeRow }){
  ...
  useEffect(()=> {
    //if [] left blank => run once when the code loads and never run again
    //if [movies]=> then whenever the movies changes the code runs
  ...
  //console.table(movies) gives in a table
